...
resource virtualHub 'Microsoft.Network/virtualHubs@2023-04-01' existing = {
  name: virtualHubName
}

output virtualHub  string = virtualHub.name

resource hubVirtualNetworkConnection 'Microsoft.Network/virtualHubs/hubVirtualNetworkConnections@2023-04-01' = {
  name: name
  parent: virtualHub
  properties: {
