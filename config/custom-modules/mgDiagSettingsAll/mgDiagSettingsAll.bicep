...
@sys.description('Deploys Diagnostic Settings on city & Online Management Groups beneath Landing Zones Management Group if set to true.')
...
@sys.description('Deploys Diagnostic Settings on Confidential city & Confidential Online Management Groups beneath Landing Zones Management Group if set to true.')
...
module modMgDiagSet '../mgDiagSettings/mgDiagSettings.bicep' = [for mgId in items(varMgIds): {
...
module modMgLandingZonesDiagSet '../mgDiagSettings/mgDiagSettings.bicep' = [for childMg in items(varLandingZoneMgDefaultChildrenUnioned): {
...
module modMgPlatformDiagSet '../mgDiagSettings/mgDiagSettings.bicep' = [for childMg in items(varPlatformMgDefaultChildrenUnioned): {
  scope: managementGroup(childMg.value)
  name: 'mg-diag-set-${childMg.value}'
  params: {
    parLogAnalyticsWorkspaceResourceId: parLogAnalyticsWorkspaceResourceId
...
module modMgChildrenDiagSet '../mgDiagSettings/mgDiagSettings.bicep' = [for childMg in varLandingZoneMgCustomChildren: {
...
module modPlatformMgChildrenDiagSet '../mgDiagSettings/mgDiagSettings.bicep' = [for childMg in varPlatformMgCustomChildren: {
  scope: managementGroup(childMg.mgId)
  name: 'mg-diag-set-${childMg.mgId}'
  params: {
    parLogAnalyticsWorkspaceResourceId: parLogAnalyticsWorkspaceResourceId
