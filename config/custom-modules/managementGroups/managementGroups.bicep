...
@sys.description('Deploys City & Online Management Groups beneath Landing Zones Management Group if set to true.')
...
@sys.description('Deploys Confidential City & Confidential Online Management Groups beneath Landing Zones Management Group if set to true.')
...
// Optional Deployment for Customer Usage Attribution NEEED TO FIX THIS VERSION NUMBER IN UPSTREAM RELEASE
module modCustomerUsageAttribution '../../../upstream-releases/v0.16.6/infra-as-code/bicep/CRML/customerUsageAttribution/cuaIdTenant.bicep' = if (!parTelemetryOptOut) {
